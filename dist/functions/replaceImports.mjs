...
import { streamToPromise } from '../utilities/streamToPromise.mjs'
/**
 ...
 */
export const replaceImports = (srcPath, destPath, config = {}, pending = [], inProgress = new Map(), ancestors = new Set()) => (content, importFile) => {
