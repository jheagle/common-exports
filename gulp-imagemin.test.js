...
const imagemin = require('./test-make-common/external-modules/gulp-imagemin/index.js').default
...
const tempDir = 'test-gulp-imagemin/'
 ...
 */
const imagesFor = (imageSrc, imageDest) =>
  src(imageSrc)
    .pipe(
        imagemin({
          interlaced: true
